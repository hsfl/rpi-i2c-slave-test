# Run on a Raspberry PI to test I2C communications with a slave device
# Requirements:
...
if __name__ == "__main__":
    ...
    parser.add_argument("-a", "--slave_address", type=int, default=i2c_slave_address, help='I2C slave address (default: 0x03)')
